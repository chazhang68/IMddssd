<template>
  <view class="hc-card">
    ...
    <view class="hc-pill" :class="{ disabled: !hasData }">
      <text class="hc-pill-text"
            :style="{ color: statusColorDisplay,
...
export default {
  name: 'HeartRateCard',
  props: {
    title: {type: String, default: '心率'},
    icon: {type: String, default: '/static/icons/heart-rate@2x.png'},
  ...
  computed: {
    ...
    statusTextSize() {
      return this.hasData ? '28rpx' : '24rpx'
    }
  }
}
</script>
