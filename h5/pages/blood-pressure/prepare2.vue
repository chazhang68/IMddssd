...
const noticeList: NoticeItem[] = [
  {
    image: '/static/images/blood-pressure/img-B1@2x.png',
    desc: '您需要一台有效的血压计。'
  },
  {
    image: '/static/images/blood-pressure/img-B2@2x.png',
    desc: '您将按照手机应用程序中的说明在三压臂套上进行2次测量。'
  },
  {
    image: '/static/images/blood-pressure/img-B3@2x.png',
    desc: '在此期间，您将需要保持佩戴设备，以便可以校准。'
  },
]
...
const handleNextStep = (): void => {
  if (uniApi?.navigateTo) {
    uniApi.navigateTo({ url: '/pages/blood-pressure/prepare3' })
    return
  }
  if (uniApi?.showToast) {
